...
extends AVP
{
	public AVP_Unsigned64(AVP baseAVP)
	...
	public AVP_Unsigned64(int code, long value) { super(code, long2byte(value)); }

	public AVP_Unsigned64(int code, int vendor, long value) {
