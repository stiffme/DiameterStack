...
extends AVP
{
	public AVP_Integer32(AVP baseAVP) throws InvalidAVPLengthException
	{
		super(baseAVP);
	...
	public AVP_Integer32(int code, int value) { super(code, int2byte(value)); }

	public AVP_Integer32(int code, int vendor, int value) {
