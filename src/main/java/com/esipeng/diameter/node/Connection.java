...
abstract class Connection {
  ...
  public Connection(NodeImplementation paramNodeImplementation, long paramLong1, long paramLong2) { this.node_impl = paramNodeImplementation;
    this.timers = new ConnectionTimers(paramLong1, paramLong2);
