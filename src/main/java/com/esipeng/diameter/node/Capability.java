...
public class Capability {
    ...
    public void addAuthApp(int auth) {
        this.auth_app.add(Integer.valueOf(auth));
    }
    ...
    public void addVendorAuthApp(int vendor, int auth) {
        this.auth_vendor.add(new VendorApplication(vendor, auth));
    }
